...
//adaugare de mai multe comentarii exlicative

void withdraw(double *balance, double amount)
{
	// as fi sters "else"-urile pentru a face codul mai lizibil
...
int main()
{
	// as fi modificat numele variabilelor
	// unele variabile se regasesc in limba romana, iar altele in limba engleza
	// modificare cu rol de cursivitate in cod

	double balantaContCurent;
	double sumaDeExtrasDinCont;

	// aceste exemple le-am scris, la momentul lor, cu scop demostrativ
	// as modifica secventele de copy paste:
	// - pentru variabilele care sunt reinitializate as folosi vectori, care vor fi parcursi ulterior, eventual un tablou bidimensional pentru perechi de valori
	// - as realiza o functie pentru mesaje si apelul care se repeta, parcurgand vectorii de la punctul anterior  
